$(document).ready(function () {
  ...
  $("#menu_plan_dime").addClass("active");
  var Op_Validar = [];
  var Op_Vali = "Ok";
  ...
  $.extend({
    ejes: function () {
      ...
      $.ajax({
        type: "POST",
        url: "../Paginadores/PagDimensiones.php",
        data: datos,
        dataType: "JSON",
    ...
    deletEjes: function (cod) {
      if (confirm("\xbfEsta seguro de realizar la operaci\xf3n?")) {
        ...
        $.ajax({
          type: "POST",
          url: "../PlanDesarrollo/GuardarDimensiones.php",
          data: datos,
          success: function (data) {
            if (data === "bien") {
              $.Alert(
              ...
              $.Alert(
                "#msg2",
                "No se Puede Realizar la Operación... Existen Componentes relacionados con este Eje.",
                "warning",
                "warning"
              );
            }
      ...
      $.ajax({
        ...
        success: function (data) {
          if (data["flag"] === "n") {
            ...
            $.Alert(
              "#msg2",
              "No se Puede Realizar la Operación... No se creado un Consecutivo para los Ejes. Verifique...",
              "warning",
              "warning"
            );
          } else {
