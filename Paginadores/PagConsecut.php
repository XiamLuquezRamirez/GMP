...
if ($busq != "") {
    ...
    $consulta = "SELECT * FROM  consecutivos  WHERE ";
    ...
    $consulta .= " order by descrip ASC LIMIT " . $regemp . "," . $regmos;
} else {

    $consulta = "SELECT * FROM consecutivos order by descrip ASC  LIMIT " . $regemp . "," . $regmos;
}
