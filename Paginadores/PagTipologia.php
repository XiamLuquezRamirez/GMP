...
if ($busq != "") {
    ...
    $consulta = "SELECT * FROM  tipologia_proyecto  WHERE ";
    ...
    $consulta .= " AND est_tipolo='ACTIVO' order by des_tipolo ASC LIMIT " . $regemp . "," . $regmos;
} else {

    $consulta = "SELECT * FROM tipologia_proyecto WHERE est_tipolo='ACTIVO' order by des_tipolo ASC  LIMIT " . $regemp . "," . $regmos;
}
...
$consulta = "SELECT count(*) as conta FROM tipologia_proyecto WHERE est_tipolo='ACTIVO'";
