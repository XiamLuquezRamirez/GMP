...
if ($busq != "") {
    ...
    $consulta = "SELECT * FROM dimensiones WHERE ";
    ...
    $consulta .= " AND estado='ACTIVO' order by descripcion ASC LIMIT " . $regemp . "," . $regmos;
} else {

    $consulta = "SELECT * FROM dimensiones WHERE estado='ACTIVO' order by descripcion ASC  LIMIT " . $regemp . "," . $regmos;
}
...
$consulta = "SELECT count(*) as conta FROM dimensiones WHERE estado='ACTIVO' ";
