...
$ruta = 'GaleriaProyecto/'; //Decalaramos una variable con la ruta en donde almacenaremos los archivos
...
echo trim($mensage, '/'); // Regresamos los mensajes generados al cliente
