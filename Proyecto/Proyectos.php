                                                            ...
                                                            <div class='row'>
                                                                ...
                                                                <div class='col-md-9'>
                                                                    <div class='form-group'>
                                                                        ...
                                                                        <div class="input-group">
                                                                            <span class="input-group-btn">
                                                                                <select class="form-control"  data-placeholder="Seleccione..."  id="CbOriFinancia" name="options2">
                                                                                    <option value="FINANCIACIÓN INTENRA">FINANCIACIÓN INTENRA</option>
                                                                                    <option value="FINANCIACIÓN EXTERNA">FINANCIACIÓN EXTERNA</option>
                                                                                </select>
                                                                            </span>
                                                                            <input type='text' id='txt_OriFin' value=""  class='form-control'/>
                                                                ...
                                                                <div class='col-md-3'>
                                                                    <div class='form-group'>
                                                                        ...
                                                                        <input type='hidden' id='txt_FinanciaTotal' value="0,00" class='form-control'/>
                                                                        <input type='text' id='txt_cosFin' value="" class='form-control'  onclick="this.select();" value="$ 0,00" onblur="textm(this.value, this.id)"/>
                                                            ...
                                                            <div class='row'>
                                                                        ...
                                                                        <div class="input-group">
                                                                            <span class="input-group-btn">
                                                                                <select class="form-control"  data-placeholder="Seleccione..."  id="CbOriPres" name="options2">
                                                                                    <option value="SERVICIOS PERSONALES INDIRECTOS">SERVICIOS PERSONALES INDIRECTOS</option>
                                                                                    ...
                                                                                    <option value="ADQUISICIÓN DE SERVICIOS">ADQUISICIÓN DE SERVICIOS </option>
                                                                                </select>
                                                                            </span>
                                                                ...
                                                                <div class='col-md-2'>
                                                                    ...
                                                                    <div class='form-group' id="From_Dato">
                                                                        ...
                                                                        <select class='form-control' id="txt_UnMed" name="options2">
                                                                ...
                                                                <div class='col-md-2'>
                                                                    <div class='form-group'>
                                                                        ...
                                                                        <input type='text' id='txt_CantPres' value="" class='form-control'/>
                                                                ...
                                                                <div class='col-md-12'>
                                                                    <div class='form-group'>
                                                                        <label class='control-label'>Valor Proyecto ($ miles corrientes):</label>

                                                                    </div>
                                                                </div>
                                                                <div class='col-md-4'>
                                                                    <div class='form-group'>
                                                                        <label class='control-label'>Vigencia actual:</label>
                                                                        <input type='hidden' id='txt_valPreVigTot' value="0" class='form-control'/>
                                                                        <input type='text' id='txt_valPreVig' value="$ 0,00" class='form-control'  onclick="this.select();" value="$ 0,00" onblur="textm(this.value, this.id)"/>
                                                                ...
                                                                <div class='col-md-4'>
                                                                    <div class='form-group'>
                                                                        ...
                                                                        <input type='hidden' id='txt_valPreTotTot' value="0" class='form-control'  />
                                                                        <input type='text' id='txt_valPreTot' value="$ 0,00" class='form-control'  onclick="this.select();" value="$ 0,00" onblur="textm(this.value, this.id)"/>
                                                                        ...
                                                                        <table class='table table-striped table-hover table-bordered' id="tb_Presup">
                                                                            ...
                                                                            <tfoot>
                                                                                <tr>
                                                                                    ...
                                                                                    <th colspan='1'><label id='gtotalPresVigAct' style='font-weight: bold;'>0,00</label></th>
