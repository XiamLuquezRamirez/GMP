...
$consulta = "SELECT cod_proyect FROM proyectos WHERE id_proyect='" . $_POST['idproy'] . "'";
$resultado1 = mysqli_query($link,$consulta);
while ($fila = mysqli_fetch_array($resultado1)) {
    $cod_pr = $fila["cod_proyect"];
}

$consulta = "DELETE FROM proyecto_galeria WHERE proyect_galeria='" . $_POST['idproy'] . "'";
