...
<html lang="en" class="no-js">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Avances de Contratos | GMP - Gestor Monitoreo Público</title>
    ...
    <link href="../Css/Global/css/sweetalert2.min.css" rel="stylesheet">
        ...
        <script src="../Js/AvanContr.js" type="text/javascript"></script>
                ...
                <div class="page-content">
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                ...
                                <a href="../Avances/AvanProyect.php">Avances de Contratos</a>
                    ...
                    <ul class="nav nav-tabs">
                        <li class="active" id="tab_01_pp">
                            <a href="#tab_01" data-toggle="tab" id="titlist" > Listado de Contratos</a>
                        </li>
                        <li id="tab_02_pp" style="display: none;">
                            <a href="#tab_02" data-toggle="tab"  id="atitulo">Agregar Avance de Contratos</a>
                        </li>
                    </ul>
                                                    ...
                                                    <div class='form-body'>
                                                        ...
                                                        <div class='row'  id="ListProyect">
                                                            ...
                                                            <div class='col-md-12'>
                                                                <div class='form-group'>
                                                                    <label>
                                                                        Busqueda:
                                                                        <input class="form-control input-large input-inline" onkeypress="$.busqProyect(this.value);" onchange="$.busqProyect(this.value);" id="busq_centro" type="search" placeholder="" aria-controls="sample_1">
                                                                    </label>
                                                        ...
                                                        <div class='row' id="ListMetas" style="display: none;">
                                                            ...
                                                            <div class="form-actions right">
                                                                <button type="button" onclick="$.volver();"  class="btn blue" ><i class="fa fa-mail-reply"></i> Volver</button>
                                                            </div>
                                                        </div>
                        ...
                        <div class="tab-pane fade" id="tab_02">
                            ...
                            <div class="portlet box purple-intense">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-angle-right"></i>Agregar Avance de Contratos
                                    </div>
                                    <div class="tools">
