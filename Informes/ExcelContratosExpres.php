...
if($_REQUEST['CbTipInf']=="1"){
  if($_REQUEST['CbEstado']==""){
     $consulta = "SELECT 
  ...
  contr.estad_contrato FROM contratos_expres contr";  
  }else{
     $consulta = "SELECT 
  contr.destipolg_contrato,
  contr.num_contrato,
  ...
  contr.veje_contrato,
  contr.porav_contrato,
  contr.estad_contrato FROM contratos_expres contr WHERE contr.estad_contrato='".$_REQUEST['CbEstado']."'";  
  }
  
}else if($_REQUEST['CbTipInf']=="2"){
    $consulta = "SELECT 
  contr.destipolg_contrato,
  contr.num_contrato,
  contr.obj_contrato,
  ...
  contr.veje_contrato,
  contr.porav_contrato,
  contr.estad_contrato FROM contratos_expres contr WHERE vadic_contrato<>0";
}else{
    $consulta = "SELECT 
  contr.destipolg_contrato,
  contr.num_contrato,
  ...
  contr.veje_contrato,
  contr.porav_contrato,
  contr.estad_contrato FROM contratos_expres contr WHERE prorg_contrato<>''";
}
...
// Se asignan las propiedades del libro
    ...
    $titulosColumnas = array('ITEM ', 'TIPOLOGÍA', 'N° DE CONTRATO', 'OBJETO DEL CONTRATO', 'VALOR DEL CONTRATO', 'ADICION',
...
//Se agregan los datos de los alumnos
    ...
    $objPHPExcel->getActiveSheet()->getStyle('A1:U1')->applyFromArray($styletitle);
