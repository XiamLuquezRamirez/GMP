...
<html lang="en" class="no-js">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Gestión de Rubro Presupuestal | Indicadores </title>
        ...
        <script src="../Js/GestionRubroPres.js" type="text/javascript"></script>
                ...
                <div class="page-content">
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                ...
                                <a href="../Parametros_Generales.php">Parametros Generales</a>
                                <i class="fa fa-circle"></i>
                            </li>
                            <li>
                                <i class="fa fa-folder-open-o"></i>
                                <a href="GestionRubroPresupuestal.php">Gestión de Rubros Presupuestales </a>
                                <i class="fa fa-circle"></i>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div id="responsive" class="modal fade" tabindex="-1" data-width="760">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id='titformi'>Datos del Rubro Presupuestal</h4>
                        </div>
                                ...
                                <div class='portlet-body form'>
                                    <form action='#' class='horizontal-form'>
                                        <div class='form-body'>
                                            ...
                                            <div class='row'>
                                                <div class='col-md-3'>
                                                    <div class='form-group' id="From_Codigo"><input type="hidden" id="acc" value="1" /><input type="hidden" id="txt_id" value="" />
                                                        <label class='control-label'>Código del Rubro:</label><span class="required">* </span>
                                                        <input type='text'  id='txt_Cod' class='form-control' />
                                                    </div>
                                                </div>
                                                <div class='col-md-9'>
                                                    <div class='form-group'  id="From_Descripcion">
                                                        <label class='control-label'>Descripción de Rubro:</label><span class="required">* </span>
                                                        <textarea id="txt_Desc" rows="2"  class='form-control' style="width: 100%"></textarea>

                                                    </div>
                                                </div>
                                                <div class='col-md-4'>
                                                    <div class='form-group'  id="From_Monto"><span class="required">* </span>
                                                        <label class='control-label'>Monto de Recursos:</label>
                                                        <input type='text'   onclick="this.select();" value="$ 0,00" onblur="textm(this.value, this.id)" id='txt_MRubro' class='form-control'/>
                                                ...
                                                <!--                                                <div class='col-md-4'>
                                                                                                    <div class='form-group'>
                                                                                                        ...
                                                                                                        <select class="form-control select2me" id="CbTGast" name="options2">
                                                ...
                                                <!--                                                <div class='col-md-5'>
                                                                                                    <div class='form-group'>
                                                                                                        <label class='control-label'>Sector de Incidencia:</label>
                                                                                                        <select class="form-control select2me" id="CbSecInc" name="options2">
                                                                                                            <option value=" ">Select...</option>
                                                                                                        </select>
                                                                                                    </div>
                                                                                                </div>-->
                                                <!--                                                <div class='col-md-5'>
                                                                                                    <div class='form-group'>
                                                                                                        <label class='control-label'>Origen del Presupuesto:</label>
                                                                                                        <select class="form-control select2me" id="CbOriPres" name="options2">
                                                                                                            <option value=" ">Select...</option>
                                                                                                        </select>
                                                                                                    </div>
                                                                                                </div>-->
                                                ...
                                                <div class='col-md-12'>
                                                    <div class='form-group'>
                                                        ...
                                                        <textarea id="txt_obser" rows="2" onkeyup='this.value = this.value.toUpperCase()' class='form-control' ></textarea>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-12">
                    ...
                    <div class="portlet box blue-soft">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-angle-right"></i>Gestión Rubros Presupuestales
                            </div>
                            <div class="tools">
                                                            ...
                                                            <div class='row'>
                                                                <div class='col-md-12'>
                                                                    <div id="sample_1_filter" class="dataTables_filter">
                                                                        <label>
                                                                            Busqueda:
                                                                            <input class="form-control input-small input-inline" onkeypress="$.busqRubro(this.value);" onchange="$.busqRubro(this.value);" id="busq_centro" type="search" placeholder="" aria-controls="sample_1">
                                                                        </label>
                                                                    ...
                                                                    <div class="table-scrollable">
                                                                        ...
                                                                        <div id="tab_Rubro" style="height: 250px;overflow: scroll;">
                                                                ...
                                                                <div class='col-md-12'  >
                                                                    ...
                                                                    <div class='row'>
                                                                        ...
                                                                        <div class='col-md-4'>
                                                                            <div id="bot_Rubro" style="float:right;">
                                                                            </div>
