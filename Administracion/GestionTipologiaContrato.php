...
<html lang="en" class="no-js">
    ...
    <head>
        ...
        <script src="../Js/GestionTipologContra.js" type="text/javascript"></script>
                ...
                <div class="page-content">
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                ...
                                <a href="../Tipologia_Contratos/">Gestión de Tipología de Contrato </a>
                    ...
                    <div id="responsive" class="modal fade" tabindex="-1" data-width="760">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id='titformi'>Gestión Tipología de Contrato</h4>
                    ...
                    <div class="portlet box blue-soft">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-angle-right"></i>Gestión de Tipología de Contrato
                            </div>
                            <div class="tools">
                                                    ...
                                                    <div class='row'>
                                                        <div class='col-md-12'>
                                                            ...
                                                            <div class="table-scrollable">
                                                                ...
                                                                <div id="tab_Tipologia" style="height: 350px;overflow: scroll;">
