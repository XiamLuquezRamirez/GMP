                                        ...
                                        <div class='row'>
                                            ...
                                            <div class='col-md-4'>
                                                <div class='form-group'>
                                                    ...
                                                    <input type='text' disabled  id='txt_PresTotal' name="txt_PresTotal" value="$ 0,00"  class='form-control'/>
                                                    <input type='hidden' value='0' id="txt_PresTotalTotal" name='txt_PresTotalTotal'/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                            <h4 class="modal-title bold" id='titformi'>Bolsas Presupuesto</h4>
                                            </div>

                                            <div class='col-md-6'>
                                                <div class='form-group' id="From_Descripcion">
                                                    <label class='control-label'>Descripción:</label><span class="required">* </span>
                                                    <input type='text'   id='txt_DescBolsa' class='form-control'/>
                                                </div>
                                            </div>
                                            ...
                                            <div class='col-md-4'>
                                                <div class='form-group'>
                                                    ...
                                                    <input type='text'   onclick="this.select();" value="$ 0,00" onblur="textm(this.value, this.id)" id='txt_ValBolsa' class='form-control'/>
                                                </div>
                                            </div>
                                            ...
                                            <div class='col-md-2'>
                                                ...
                                                <a onclick="$.AddBolsa()" class="btn green-meadow">
                                            ...
                                            <div class="col-md-12">
                                            <h5 class="modal-title bold" id='titformi'>Bolsas Agregadas</h5>
                                            </div>

                                            <div class="col-md-12">
                                                <div class="form-group" style="overflow:auto; height:200px;" >
                                                    <table class="table table-striped table-hover table-bordered" id="tb_Bolsas"> <thead>
                                                        <tr>
                                                            <td>
                                                    ...
                                                    <div class='row'>
                                                        <div class='col-md-12'>
                                                            <div id="sample_1_filter" class="dataTables_filter">
                                                                <label>
                                                                    Busqueda:
                                                                    <input class="form-control input-small input-inline" onkeypress="$.busqPresu(this.value);" onchange="$.busqPresu(this.value);" id="busq_centro" type="search" placeholder="" aria-controls="sample_1">
                                                                </label>
                                                        ...
                                                        <div class='col-md-12'>
                                                            ...
                                                            <div class='row'>
                                                                ...
                                                                <div class='col-md-4'>
                                                                    <div id="bot_Presupuesto" style="float:right;">
                                                                    </div>
