...
<html lang="en" class="no-js">
    ...
    <head>
        <meta charset="utf-8"/>
        <title> Gestión de Responsables | SGP Gestor Publico de Gobierno</title>
        ...
        <script src="../Js/GestionResponsables.js" type="text/javascript"></script>
                ...
                <div class="page-content">
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                ...
                                <a href="../Responsables/">Gestión de Responsables </a>
                    ...
                    <div id="responsive" class="modal fade" tabindex="-1" data-width="760">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id='titformi'>Datos del Responsable</h4>
                                ...
                                <div class='portlet-body form'>
                                    ...
                                    <div class='form-body'>
                                        ...
                                        <div class='row'>
                                            ...
                                            <div class='col-md-5'>
                                                <div class='form-group' id="From_Dependencia">
                                                    <label class='control-label'>Dependencia:</label><span class="required">* </span>
                                                    <select class="form-control select2" id="CbDependencia" name="options2">
                                            ...
                                            <div class='col-md-3'>
                                                <div class='form-group'>
                                                    ...
                                                    <input type='text'   id='txt_Telf' class='form-control'/>
                                                </div>
                                            </div>
                                            <div class='col-md-12'>
                                                <div class='form-group'>
                    ...
                    <div class="portlet box blue-soft">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-angle-right"></i>Gestión de Responsables.
                            </div>
                            <div class="tools">
                                                    ...
                                                    <div class='row'>
                                                        <div class='col-md-12'>
                                                            <div id="sample_1_filter" class="dataTables_filter">
                                                                <label>
                                                                    Busqueda:
                                                                    <input class="form-control input-small input-inline" onkeypress="$.busqResponsa(this.value);" onchange="$.busqResponsa(this.value);" id="busq_centro" type="search" placeholder="" aria-controls="sample_1">
                                                                </label>
                                                            ...
                                                            <div class="table-scrollable">
                                                                ...
                                                                <div id="tab_Responsables" style="height: 250px;overflow: scroll;">
                                                        ...
                                                        <div class='col-md-12'  >
                                                            ...
                                                            <div class='row'>
                                                                ...
                                                                <div class='col-md-4'>
                                                                    <div id="bot_Responsables" style="float:right;">
                                                                    </div>
