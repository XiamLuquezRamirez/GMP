...
<html lang="en" class="no-js">
    ...
    <head>
        <meta charset="utf-8"/>
        <title> Gestión de Procesos | Indicadores</title>
        ...
        <script src="../Js/GestionProcesos.js" type="text/javascript"></script>
                ...
                <div class="page-content">
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                ...
                                <a href="GestionProcesos.php">Gestión de Procesos </a>
                    ...
                    <div id="responsive" class="modal fade" tabindex="-1" data-width="760">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id='titformi'>Datos del Proceso</h4>
                                ...
                                <div class='portlet-body form'>
                                    ...
                                    <div class='form-body'>
                                        ...
                                        <div class='row'>
                                            ...
                                            <div class='col-md-7'>
                                                <div class='form-group' id="From_Macro">
                                                    <label class='control-label'>Macroproceso:</label><span class="required">* </span>
                                                    <select class='form-control' id="CbMacro" name="options2">
                    ...
                    <div class="portlet box blue-soft">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-angle-right"></i>Gestión de Procesos.
                            </div>
                            <div class="tools">
                                                    ...
                                                    <div class='row'>
                                                        <div class='col-md-12'>
                                                            ...
                                                            <div class="table-scrollable">
                                                                ...
                                                                <div id="tab_Proceso" style="height: 250px;overflow: scroll;">
                                                        ...
                                                        <div class='col-md-12'  >
                                                            ...
                                                            <div class='row'>
                                                                ...
                                                                <div class='col-md-4'>
                                                                    <div id="bot_Proceso" style="float:right;">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
