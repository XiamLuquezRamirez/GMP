...
<html lang="en" class="no-js">
    ...
    <head>
        <meta charset="utf-8"/>
        <title> Gestión de Origen de la Información | Indicadores</title>
        ...
        <script src="../Js/GestionOrigenInformacion.js" type="text/javascript"></script>
                ...
                <div class="page-content">
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                ...
                                <a href="GestionOrigenInformacion.php">Gestión de Origen de la Información </a>
                                <i class="fa fa-circle"></i>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div id="responsive" class="modal fade" tabindex="-1" data-width="760">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id='titformi'>Datos Origen de la Información</h4>
                    ...
                    <div class="portlet box blue-soft">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-angle-right"></i>Gestión de Origen de la Información
                            </div>
                            <div class="tools">
