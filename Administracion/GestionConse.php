...
<html lang="en" class="no-js">
    ...
    <head>
        <meta charset="utf-8"/>
        <title> Gestión de Consecutivos | SGP Gestor Publico de Gobierno</title>
        ...
        <script src="../Js/GesConsecutivos.js" type="text/javascript"></script>
                ...
                <div class="page-content">
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                ...
                                <a href="../Consecutivos/">Gestión de Consecutivos</a>
                    ...
                    <div id="responsive" class="modal fade" tabindex="-1" data-width="760">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id='titformi'>Datos del Consecutivo</h4>
                            ...
                            <div class="row">
                                <div class='portlet-body form'>
                                    ...
                                    <div class='form-body'>
                                        ...
                                        <div class='row'>
                                            <div class='col-md-2'>
                                                <div class='form-group' id="From_Estr"><input type="hidden" id="acc" value="1" /><input type="hidden" id="txt_id" value="1" />
                                                    <label class='control-label'>Estructura:</label><span class="required">* </span>
                                                    <input type='text' onkeyup='this.value = this.value.toUpperCase()'  id='txt_Estr' onchange="$.estruct();" class='form-control' />
                                                </div>
                                            </div>
                                            <div class='col-md-4'>
                                                <div class='form-group' id="From_Grupo">
                                            ...
                                            <div class='col-md-6'>
                                                <div class='form-group'>
                                                    ...
                                                    <input type='text'   onkeyup='this.value = this.value.toUpperCase()' id='txt_Desc' class='form-control'/>
                                                </div>
                                            </div>
                                            <div class='col-md-2'>
                                                <div class='form-group'>
                                            ...
                                            <div class='col-md-2'>
                                                <div class='form-group'>
                                                    ...
                                                    <input type='text'  onkeyup='this.value = this.value.toUpperCase()'  onchange="$.estruct();"  value="0"  id='txt_ini' class='form-control'/>
                                                </div>
                                            </div>
                                            <div class='col-md-2'>
                                                <div class='form-group'>
                                                    <label class='control-label'>Actual:</label>
                                                    <input type='text' disabled  onkeyup='this.value = this.value.toUpperCase()' value="0" id='txt_act' class='form-control'/>
                                                </div>
                                            </div>
                                            <div class='col-md-3'>
                                                <div class='form-group'>
                                                    <label class='control-label'>Agregar Vigencia Actual:</label>
                                                    <select class='form-control' id="CbVige"  onchange="$.estruct();"  name="options2">
                                                        <option value="">Select...</option>
                                            ...
                                            <div class='col-md-3'>
                                                <div class='form-group'>
                                                    <label class='control-label'>Estructura Establecida:</label>
                                                    <input type='text'  onkeyup='this.value = this.value.toUpperCase()' disabled id='txt_EstrucEst' class='form-control'/>
                                                </div>
                                            </div>
                    ...
                    <div class="portlet box blue-soft">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-angle-right"></i>Gestión de Consecutivos.
                            </div>
                            <div class="tools">
                                                    ...
                                                    <div class='row'>
                                                        <div class='col-md-12'>
                                                            <div id="sample_1_filter" class="dataTables_filter">
                                                                <label>
                                                                    Busqueda:
                                                                    <input class="form-control input-small input-inline" onkeypress="$.busqConse(this.value);" onchange="$.busqConse(this.value);" id="busq_centro" type="search" placeholder="" aria-controls="sample_1">
                                                                </label>
                                                            ...
                                                            <div class="table-scrollable">
                                                                ...
                                                                <div id="tab_Conse" style="height: 250px;overflow: scroll;">
                                                        ...
                                                        <div class='col-md-12'  >
                                                            ...
                                                            <div class='row'>
                                                                ...
                                                                <div class='col-md-4'>
                                                                    <div id="bot_Conse" style="float:right;">
                                                                    </div>
