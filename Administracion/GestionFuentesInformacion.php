...
<html lang="en" class="no-js">
    ...
    <head>
        <meta charset="utf-8"/>
        <title> Gestión Fuente de Información | GMP - Gestor Monitoreo Público</title>
        ...
        <script src="../Js/GestionFuenteInformacion.js" type="text/javascript"></script>
                ...
                <div class="page-content">
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                ...
                                <a href="../Menu_Parametros_Generales/">Parametros Generales</a>
                                <i class="fa fa-circle"></i>
                            </li>
                            <li>
                           <i style="color: yellow;" class="fa fa-star"></i>
                                <a href="../Fuentes/">Gestión Fuente de Información  </a>
                                <i class="fa fa-circle"></i>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div id="responsive" class="modal fade" tabindex="-1" data-width="760">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id='titformi'>Datos Fuente de Información</h4>
                                ...
                                <div class='portlet-body form'>
                                    ...
                                    <div class='form-body'>
                                        ...
                                        <div class='row'>
                                            ...
                                            <div class='col-md-12'><input type="hidden" id="acc" value="1" /><input type="hidden" id="txt_id" value="1" />
                    ...
                    <div class="portlet box blue-soft">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-angle-right"></i>Gestión Fuente de Información
                            </div>
                            <div class="tools">
                                                    ...
                                                    <div class='row'>
                                                        <div class='col-md-12'>
                                                            ...
                                                            <div class="table-scrollable">
                                                                ...
                                                                <div id="tab_Fuente" style="height: 250px;overflow: scroll;">
                                                        ...
                                                        <div class='col-md-12'  >
                                                            ...
                                                            <div class='row'>
                                                                ...
                                                                <div class='col-md-4'>
                                                                    <div id="bot_Fuente" style="float:right;">
                                                                    </div>
