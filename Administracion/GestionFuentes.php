                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                ...
                                <a href="../Administracion/Fuentes.php">Gestión de Fuentes</a>

                            </li>
                        </ul>
                    </div>
                    <h3 class="page-title">  GMP - Gestor Monitoreo Público | Gestion de Fuentes</h3>
                    <br>
                    <div class="row" id="divAlertas">
                        <div class="col-md-12">
                            <div class="portlet box red">
                                <div class="portlet-title">
                                    <div class="caption"><i class="icon-cogs"></i>Gestionar Fuentes</div>
                                    <div class="tools">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class='col-md-12'>
                        <div class="portlet box red">
                            <div class="portlet-title">
                                <div class="caption"><i class="icon-cogs"></i>Datos de la Fuente</div>
                                <div class="tools">
                                                ...
                                                <div class='row'>
                                                    <div class="col-md-12">
                                                        <div class="form-group" id="From_Nombre">
                                                            ...
                                                            <label class='control-label' for='nombre'>Fuente:<span class="required">* </span></label>
