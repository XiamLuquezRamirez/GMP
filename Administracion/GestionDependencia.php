...
<html lang="en" class="no-js">
    ...
    <head>
        <meta charset="utf-8"/>
        <title> Gestión de Dependencias | SGP Gestor Publico de Gobierno</title>
        ...
        <script src="../Js/GestionDependencias.js" type="text/javascript"></script>
                ...
                <div class="page-content">
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                ...
                                <a href="GestionDependencias.php">Gestión de Dependencias </a>
                    ...
                    <div id="responsive" class="modal fade" tabindex="-1" data-width="760">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id='titformi'>Datos de la Dependencia</h4>
                    ...
                    <div class="portlet box blue-soft">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-angle-right"></i>Gestión de Dependencias.
                            </div>
                            <div class="tools">
                                                    ...
                                                    <div class='row'>
                                                        <div class='col-md-12'>
                                                            ...
                                                            <div class="table-scrollable">
                                                                ...
                                                                <div id="tab_Dependencia" style="height: 250px;overflow: scroll;">
                                                        ...
                                                        <div class='col-md-12'  >
                                                            ...
                                                            <div class='row'>
                                                                ...
                                                                <div class='col-md-4'>
                                                                    <div id="bot_Dependencia" style="float:right;">
                                                                    </div>
