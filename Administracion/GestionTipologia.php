...
<html lang="en" class="no-js">
    ...
    <head>
        <meta charset="utf-8"/>
        <title> Gestión de Tipología de Proyecto | SGP Gestor Publico de Gobierno</title>
        ...
        <script src="../Js/GestionTipologProyect.js" type="text/javascript"></script>
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                ...
                                <a href="../Tipologia_Proyectos/">Gestión de Tipología de Proyecto </a>
                    ...
                    <div id="responsive" class="modal fade" tabindex="-1" data-width="760">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                            <h4 class="modal-title" id='titformi'>Gestión Tipología de Proyecto</h4>
                            ...
                            <div class="row">
                                <div class='portlet-body form'>
                                    ...
                                    <div class='form-body'>
                                        ...
                                        <div class='row'>
                                            <div class='col-md-4'>
                                                <div class='form-group' id="From_Codigo"><input type="hidden" id="acc" value="1" /><input type="hidden" id="txt_id" value="1" />
                    ...
                    <div id="modalClasif" class="modal fade" tabindex="-1" data-width="760">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                            <h4 class="modal-title" id='titformi'>Datos Clasificación de Proyectos</h4>
                        </div>
                        <div class="modal-body">
                            <div class="row">
                                <div class='portlet-body form'>
                                    ...
                                    <div class='form-body'>
                                        ...
                                        <div class='row'>
                                            <div class='col-md-4'>
                                                <div class='form-group' id="From_CodigoTip">
                                                    <label class='control-label'>Código:</label><span class="required">* </span>

                                                    <div class="form-inline">
                                                        <div class="form-group">
                                                            <div class="input-group" >
                                                                <input type="text" id="txt_codTip"  class="form-control input-xsmall" disabled />
                                                            </div>
                                                        </div>
                                                        <div class="form-group" id="From_CodigoTip">
                                                            <input type="text" id="txt_codClas" class="form-control input-xsmall"/>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class='col-md-8'>
                                                <div class='form-group' id="From_DescripcionTip">
                                                    <label class='control-label'>Descripción:</label><span class="required">* </span>
                                                    <input type='text'   id='txt_DescClas' class='form-control'/>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12">
                                            ...
                                            <div class="form-actions right" >
                                                <button type="button" class="btn green"onclick="$.AddTipolProyect()"><i class="fa fa-save"></i> Guardar</button>
                                            </div>
                                            <div class='col-md-12'>
                                                <div class='form-group'>
                                                    <table class='table table-striped table-hover table-bordered' id="tb_Clasif">
                                                        <thead>
                                                            <tr>
                                                                <td>
                    ...
                    <div class="portlet box blue-soft">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-angle-right"></i>Gestión de Tipología de Proyectos
                            </div>
                            <div class="tools">
                                                    ...
                                                    <div class='row'>
                                                        <div class='col-md-12'>
                                                            <div id="sample_1_filter" class="dataTables_filter">
                                                                <label>
                                                                    Busqueda:
                                                                    <input class="form-control input-small input-inline" onkeypress="$.busqOrInfo(this.value);" onchange="$.busqOrInfo(this.value);" id="busq_centro" type="search" placeholder="" aria-controls="sample_1">
                                                                </label>
                                                            ...
                                                            <div class="table-scrollable">
                                                                ...
                                                                <div id="tab_Tipologia" style="height: 250px;overflow: scroll;">
                                                        ...
                                                        <div class='col-md-12'  >
                                                            ...
                                                            <div class='row'>
                                                                ...
                                                                <div class='col-md-4'>
                                                                    <div id="bot_Tipologia" style="float:right;">
                                                                    </div>
