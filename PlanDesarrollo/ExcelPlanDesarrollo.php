...
<table class="tg">
    <thead>
        <tr>
            ...
            <th class="tg-0lax" colspan="2" rowspan="3"><h2>PLAN DE DESARROLLO - <?php echo $hoy; ?></h2></th>
        </tr>
        <tr>
        </tr>
        <tr>
    ...
    <tbody>
        <tr>
            <td class="tg-1wig" style="border: #000 1px solid;"><b>DIMENSIONES</b></td>
            <td class="tg-1wig" style="border: #000 1px solid;"><b>EJES ESTRATEGICOS</b></td>
            <td class="tg-1wig" style="border: #000 1px solid;"><b>PROGRAMAS</b></td>
            <td class="tg-1wig" style="border: #000 1px solid;"><b>SUBPROGRAMAS</b></td>
        </tr>
        <?php
        $total = 0;
        ...
        while ($data = mysqli_fetch_array($resultado)) {
            ?>
            <tr>
                <td style="vertical-align: middle;border: #000 1px solid;text-align: justify;"><?php echo $data["dim"]; ?></td>
