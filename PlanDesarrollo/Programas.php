...
<html lang="en" class="no-js">
    ...
    <head>
        <meta charset="utf-8"/>
        <title> Gestión de <?php echo $_SESSION['nivel3']; ?> | GMP - Gestor Monitoreo Público</title>
        ...
        <script src="../Js/GestionProgramas.js" type="text/javascript"></script>
        <script src="../Js/funciones_generales.js" type="text/javascript"></script>
    </head>
    <!-- END HEAD -->

    <!-- BEGIN BODY -->
    <input type="hidden" id="conse" value="<?php echo $_SESSION['nivel3'] ?>" />
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                ...
                                <a href="../SubProgramas/">Gestión de <?php echo $_SESSION['nivel3']; ?> </a>
                    ...
                    <div id="responsive" class="modal fade" tabindex="-1" data-width="900">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                            <h4 class="modal-title" id='titformi'>Datos del <?php echo $_SESSION['nivel3']; ?></h4>
                                ...
                                <div class='portlet-body form'>
                                    ...
                                    <div class='form-body'>
                                                        ...
                                                        <div class="form-group" id="From_Codigo0">
                                                            <div class="input-group" >
                                                                <span class="input-group-btn">
                                                                    <button type="button" id="btn_para" title="Busqueda" class="btn green-meadow">
                                                                        <i class="fa fa-search fa-fw"/></i>
                                                                    </button>
                                                                </span>
                                                                <input type="text" id="txt_cod_pp" title="Código" class="form-control" disabled />
                                        ...
                                        <div class="row" id="nestr" style="display: none">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="hidden" id="txt_id_ej"  class="form-control" disabled />
                                                    <textarea id="txt_nomb_eje" cols="2" class="form-control txt" disabled></textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="control-label"><?php  echo  $_SESSION['nivel2']; ?>:</label>
                                                    <input type="hidden" id="txt_id_Est"  class="form-control" disabled />
                                        ...
                                        <div class="form-actions right" id="mopc" >
                                            ...
                                            <?php
                                            if ($_SESSION['GesPlaAPr'] == "s") {
                                                echo '<button type="button" class="btn purple" disabled id="btn_nuevo2"><i class="fa fa-file-o"></i> Nuevo</button>';
                                            }
                                            ?>
                                            <button type="button" id="btn_cerrar" data-dismiss="modal" class="btn yellow-casablanca"><i class="fa fa-close"></i> Cerrar</button>
                            ...
                            <div class='row'>
                                <div class='col-md-12'>
                                    <div id="sample_1_filter" class="dataTables_filter">
                                        <label>
                                            Busqueda:
                                            <input class="form-control input-small input-inline" onkeyup="$.busqProgramasVent(this.value);"   id="busq" type="search" placeholder="" aria-controls="sample_1">
                                        </label>
                                    </div>
                    ...
                    <div class="portlet box blue-soft">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-angle-right"></i>Gestión de <?php echo $_SESSION['nivel3']; ?>.
                            </div>
                            <div class="tools">
                                                    ...
                                                    <div class='row'>
                                                        <div class='col-md-12'>
                                                            <div id="sample_1_filter" class="dataTables_filter">
                                                                <label>
                                                                    Busqueda:
                                                                    <input class="form-control input-small input-inline" onkeyup="$.busqProgramas(this.value);"  id="busq_centro" type="search" placeholder="" aria-controls="sample_1">
                                                                </label>
                                                            ...
                                                            <div class="table-scrollable">
                                                                ...
                                                                <div id="tab_Programas" style="height: 300px;overflow: scroll;">
                                                        ...
                                                        <div class='col-md-12'  >
                                                            ...
                                                            <div class='row'>
                                                                ...
                                                                <div class='col-md-4'>
                                                                    <div id="bot_Programas" style="float:right;">
                                                                    </div>
