...
$hoy = date("Y");
header("Content-Disposition: attachment; filename=SubProgramasPlanDesarrollo$hoy.xls");
?>
<meta charset="utf-8"/>
<style type="text/css">
...
<table class="tg">
    <thead>
        <tr>
            <th class="tg-7fle" colspan="2" rowspan="1"><img src="http://gmp.leeringenieria.com/Img/logo-big.png" width="250" height="100"></th>
            <th class="tg-0lax" colspan="1" rowspan="1"><h2>SUBPROGRAMAS - PLAN DE DESARROLLO - <?php echo $hoy; ?></h2></th>
        </tr>
        <tr>
        </tr>
        <tr>
    ...
    <tbody>
        ...
        $sql = "SELECT  * from programas where ESTADO='ACTIVO'";
