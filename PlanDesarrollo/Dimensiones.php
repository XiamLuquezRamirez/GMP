...
<html lang="en" class="no-js">
    ...
    <head>
        <meta charset="utf-8"/>
        <title> Gestión de Dimensiones | GMP - Gestor Monitoreo Público</title>
        ...
        <script src="../Js/GestionDimensiones.js" type="text/javascript"></script>
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                ...
                                <a href="../Dimensiones/">Gestión de Dimensiones </a>
                    ...
                    <div id="responsive" class="modal fade" tabindex="-1" data-width="760">
                        <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                            <h4 class="modal-title" id='titformi'>Datos de la Dimensión</h4>
                            ...
                            <div class="row">
                                <div class='portlet-body form'>
                                    ...
                                    <div class='form-body'>
                                        ...
                                        <div class='row'>
                                            <div class='col-md-4'>
                                                <div class='form-group' id="From_Codigo"><input type="hidden" id="acc" value="1" /><input type="hidden" id="txt_id" value="1" /><input type="hidden" id="cons" value="1" />
                                                    <label class='control-label'>Código:</label><span class="required">* </span>

                                                    <input type='text' onkeyup='this.value = this.value.toUpperCase()' disabled=""  id='txt_Cod' class='form-control' />
                                                </div>
                                            </div>
                                            <div class='col-md-8'>
                                                    ...
                                                    <div class='row'>
                                                        <div class='col-md-12'>
                                                            <div id="sample_1_filter" class="dataTables_filter">
                                                                <label>
                                                                    Busqueda:
                                                                    <input class="form-control input-small input-inline" onkeyup="$.busqResponsa(this.value);" id="busq_ejes" type="search" placeholder="" aria-controls="sample_1">
                                                                </label>
...
<!--                                                                    <div class="btn-group dropup">
                                                            ...
                                                            <div class="table-scrollable">
                                                                ...
                                                                <div id="tab_Ejes" style="height: 250px;overflow: scroll;">
                                                        ...
                                                        <div class='col-md-12'  >
                                                            ...
                                                            <div class='row'>
                                                                ...
                                                                <div class='col-md-4'>
                                                                    <div id="bot_Ejes" style="float:right;">
                                                                    </div>
