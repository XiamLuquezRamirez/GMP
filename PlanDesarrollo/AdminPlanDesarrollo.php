...
<html lang="es">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Plan de Desarrollo | GMP - Gestor Monitoreo Público </title>
        ...
        <script src="../Js/AdminitracionPlanDesa.js" type="text/javascript"></script>
    </head>
    <!-- END HEAD -->
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                    ...
                    <h3 class="page-title"> Administraci&oacute;n Plan de Desarrollo
                    </h3>
                    <div class="tiles">
                        <?php if ($_SESSION['GesPlaVEj'] == "s") { ?>
                            <div id="btn_ejes" class="tile bg-purple">
                                <div class="tile-body">
                        ...
                        <?php } ?>
                        <?php if ($_SESSION['GesPlaVCo'] == "s") { ?>
                            <div id="btn_Componentes" class="tile bg-blue">
                                <div class="tile-body">
                                    <i class="fa fa-th-list"></i>
                                </div>
                                <div class="tile-object">
                        ...
                        <?php } ?>
                        <?php if ($_SESSION['GesPlaVPr'] == "s") { ?>
                            <div id="btn_programas" class="tile bg-green">
                                <div class="tile-body">
                                    <i class="fa fa-th-list"></i>
                                </div>
                                <div class="tile-object">
                        ...
                        <?php } ?>
                        <?php if ($_SESSION['GesPlaVMe'] == "s") { ?>
                            <div id="btn_Metas" class="tile bg-red">
                                <div class="tile-body">
